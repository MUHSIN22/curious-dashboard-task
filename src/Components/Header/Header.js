        ...
        <header className="header">
            <div className="header-mobile">
                ...
                <div className="header-btns">
                    <button className="preview-and-copy" onClick={()=>setToggles({...toggles,preview: true})}>Preview</button>
                    <button className="preview-and-copy">Copy</button>
                    <button className="hamburger-btn" onClick={()=>setToggles({...toggles,nav:true})}>
